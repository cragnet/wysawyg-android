...
class MainActivity : AppCompatActivity() {
    ...
    private fun saveSettings() {
        getSharedPreferences(PREFS_NAME, MODE_PRIVATE).edit().apply {
            putString(PREF_ALARMA_URL, alarmaUrlInput.text.toString().ifBlank { "http://localhost:11434/api/chat" })
    ...
    private fun loadSettings() {
        ...
        val url = prefs.getString(PREF_ALARMA_URL, "http://localhost:11434/api/chat") ?: "http://localhost:11434/api/chat"
