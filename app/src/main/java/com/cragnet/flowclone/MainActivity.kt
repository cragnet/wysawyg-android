...
class MainActivity : AppCompatActivity() {
    ...
    private fun saveSettings() {
        getSharedPreferences("flowclone", MODE_PRIVATE).edit().apply {
            putString("ollama_url", urlInput.text.toString().ifBlank { "http://localhost:11434/api/chat" })
    ...
    private fun loadSettings() {
        ...
        urlInput.setText(prefs.getString("ollama_url", "http://localhost:11434/api/chat"))
